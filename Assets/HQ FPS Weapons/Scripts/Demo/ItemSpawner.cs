...
namespace HQFPSWeapons
{
	public class ItemSpawner : MonoBehaviour
	{
		...
		private IEnumerator C_SpawnItems(List<ItemPickup> itemsToSpawn) 
		{
			...
			m_StartSpawnAudio.Play(ItemSelection.Method.RandomExcludeLast, m_AudioSource, GlobalVolumeManager.Instance.GetSoundVol());
			...
			m_EndSpawnAudio.Play(ItemSelection.Method.RandomExcludeLast, m_AudioSource, GlobalVolumeManager.Instance.GetSoundVol());
		}
